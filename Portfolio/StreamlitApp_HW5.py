...
MODEL_INFO = {
        ...
        "explainer": 'explainerp_pca.shap',
        "pipeline": 'finalized_pca_model.tar.gz',
        "keys": ["TSLA"],
        "inputs": [{"name": k, "type": "number", "min": -1.0, "max": 1.0, "default": 0.0, "step": 0.01} for k in ["TSLA"]]
}
...
def display_explanation(input_df, session, aws_bucket):
    ...
    dataset = pd.read.csv(r'./SP500Data.csv', index_col=0)
    random = 'TSLA'
