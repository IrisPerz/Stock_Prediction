...
MODEL_INFO = {
        ...
        "keys": ["AAPL", "MPWR"],
        "inputs": [{"name": k, "type": "number", "min": 0.0, "max": 0.0, "default": 0.0, "step": 10.0} for k in ["AAPL", "MPWR"]]
}
...
def display_explanation(input_df, session, aws_bucket):
    ...
    best_pipeline = load_pipeline(session,aws_bucket, 'r'sklearn-pipeline-deployment')
