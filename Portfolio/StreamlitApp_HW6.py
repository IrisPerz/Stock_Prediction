...
MODEL_INFO = {
        ...
        "keys": ['ADBE','GOOG','AMZN','sentiment_lex'],
        "inputs": [{"name": k, "type": "number", "min": -1.0, "max": 1.0, "default": 0.0, "step": 0.01} for k in ['ADBE','GOOG','AMZN','sentiment_lex']]
}
...
def display_explanation(input_df, session, aws_bucket):
    ...
    index=shap_values[0].feature_names).abs().idxmax()
